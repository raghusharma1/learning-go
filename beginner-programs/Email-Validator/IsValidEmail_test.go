...
func TestIsValidEmail(t *testing.T) {
    ...
    testCases := []struct {
        ...
        {"test.example", false},  
        {"", false},  
        {"a@b.c" + strings.Repeat("d", 250), false},  
        {"a@b.c" + strings.Repeat("d", 249), true},  
    }
    ...
    for _, testCase := range testCases {
        ...
        if result != testCase.isValid {
            t.Errorf("Expected result for email '%v' is '%v', but got '%v'", testCase.email, testCase.isValid, result)
        }
    }
}
