...
func TestIsValidEmail(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			email:    "a@b..com",
			expected: false,
		},
		{
			email:    "a@b.c",
	...
	for i, tc := range testCases {
		...
		if actual != tc.expected {
			t.Errorf("IsValidEmail(%q) = %v; expected %v", tc.email, actual, tc.expected)
		} else {
			t.Logf("IsValidEmail(%q) = %v; passed", tc.email, actual)
		}
	}
}
