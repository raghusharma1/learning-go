...
func TestIsValidEmail(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			email:    "thisIsAReallyLongEmailAddressThatIsDefinitelyMoreThan255CharactersLongAndShouldNotBeConsideredAsAValidEmailAddressBecauseItExceedsTheMaximumLengthThatIsAllowedByTheEmailStandard@example.com",
			expected: false,
		},
	}
