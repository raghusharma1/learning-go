...
func TestIsValidEmail(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			email:    "thisisaverylongemailaddressthatexceedsthemaximumlengthallowedbytheemailspecification@example.com",
			expected: false,
		},
	}
	...
	for _, testCase := range testCases {
		t.Run(testCase.email, func(t *testing.T) {
			...
			if result != testCase.expected {
				...
				t.Logf("IsValidEmail(%v) = %v; passed", testCase.email, result)
			}
		})
	}
}
