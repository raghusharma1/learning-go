...
func TestIsValidEmail(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			name:           "Long email",
			email:          "this.is.really.long.email.that.is.longer.than.two.hundred.and.fifty.five.characters.abcdefghijklmnopqrstuvwxyz.abcdefghijklmnopqrstuvwxyz.abcdefghijklmnopqrstuvwxyz.abcdefghijklmnopqrstuvwxyz.abcdefghijklmnopqrstuvwxyz.abcdefghijklmnopqrstuvwxyz.abcdefghijklmnopqrstuvwxyz.abcdefghijklmnopqrstuvwxyz.abcdefghijklmnopqrstuvwxyz.abcdefghijklmnopqrstuvwxyz.abcdefghijklmnopqrstuvwxyz.abcdefghijklmnopqrstuvwxyz.abcdefghijklmnopqrstuvwxyz@example.com",
			expectedResult: false,
		},
	}
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			// Call function with test case parameters
			result := IsValidEmail(tc.email)

			// Check if result is as expected
			if result != tc.expectedResult {
				t.Errorf("For email '%s', expected result %v but got %v", tc.email, tc.expectedResult, result)
			}
		})
	}
}
