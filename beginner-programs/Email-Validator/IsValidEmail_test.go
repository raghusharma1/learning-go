...
func TestIsValidEmail(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			email: "this.is.a.very.long.email.address.that.is.actually.more.than.two.hundred.and.fifty.five.characters.long.and.therefore.should.not.be.considered.as.a.valid.email.address@example.com", // very long email
			want:  false,
		},
	}
	...
	for _, tc := range testCases {
		t.Run(tc.email, func(t *testing.T) {
			...
			if got != tc.want {
				...
				t.Logf("IsValidEmail(%s) = %v; passed", tc.email, got)
			}
		})
	}
}
