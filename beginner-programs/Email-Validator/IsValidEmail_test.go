...
func TestIsValidEmail(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			email: "this.is.a.very.long.email.address.that.is.longer.than.255.characters."+
				"this.is.a.very.long.email.address.that.is.longer.than.255.characters."+
				"this.is.a.very.long.email.address.that.is.longer.than.255.characters."+
				"this.is.a.very.long.email.address.that.is.longer.than.255.characters."+
				"this.is.a.very.long.email.address.that.is.longer.than.255.characters."+
				"this.is.a.very.long.email.address.that.is.longer.than.255.characters.@example.com", // long email
			want:  false,
		},
	}
