...
func TestIsValidEmail(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			email:    "LoremipsumdolorsitametconsecteturadipiscingelitMorbimolestienislluctusrisusplaceratidpretiumnullafermentumNullamquisdiamnecleoconvalliscongueQuisquevitaeliberoorciluctusamet@long.com",
			expected: false,
		},
		{
			name:     "empty string",
